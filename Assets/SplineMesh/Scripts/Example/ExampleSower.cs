...
namespace SplineMesh
{
    ...
    public class ExampleSower : MonoBehaviour
    {
        ...
        public bool useYRotation = false;
        ...
        public void Sow()
        {
            ...
            while (distance <= spline.Length)
            {
                ...
                if (useYRotation) go.transform.localRotation = Quaternion.Euler(go.transform.rotation.eulerAngles.x, yRotation, go.transform.rotation.eulerAngles.z);
